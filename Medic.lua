script_name('Medic')
script_authors("Galileo_Galilei")
...
function main()
	...
	sampAddChatMessage("{ff263c}[Medic] {ffffff}Скрипт успешно загружен. {fc0303}Версия: 2.0.0", -1)
	sampAddChatMessage("{ff263c}[Medic] {ffffff}Автор: Galileo_Galilei", -1)
